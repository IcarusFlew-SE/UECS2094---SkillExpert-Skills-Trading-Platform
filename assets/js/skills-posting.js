// JS-Script for Skills Post Module
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function previewPulse() {
        ...
        void previewCard.offsetWidth; // force browser reset animation
 ...
 /* ==========================================
    ...
    /* ==========================================
       SHARED SKILL FORM VALIDATION
       ========================================== */
    document.querySelectorAll('[data-validate-skill-form]').forEach(
        function (skillForm) {
            skillForm.addEventListener('submit', function (event) {
                const managedTitle = skillForm.querySelector('[name="title"]');
                const managedCategory = skillForm.querySelector('[name="category"]');
                const managedDescription = skillForm.querySelector('[name="description"]');
                if (
                    !managedTitle.value.trim() ||
                    !managedCategory.value.trim() ||
                    !managedDescription.value.trim()
                ) {
                    event.preventDefault();
                    alert('Please complete all required skill fields before saving.');
                }
            });
        }
    );